...
namespace Universal_x86_Tuning_Utility.Views.Windows
{
    public partial class InstallpawnIo : FluentWindow
    {
        ...
        public InstallpawnIo()
        {
            ...
            ToggleButton.Content = "Install Driver";
        ...
        private async Task InstallPawnIoAsync()
        {
            try
            {
                ...
                {
                    tbxInfo.Text = "Downloading the PawnIO driver installer...";
                }

                await DownloadPawnIoInstallerAsync();

                tbxInfo.Text = "Installing the PawnIO driver silently. Please wait...";
                ...
                else
                {
                    FinishProgress(
                        ...
                        "The driver may not have installed correctly. Please try again, or run the installer manually as administrator.");
                }
            }
            catch (Exception ex)
            {
